...
public class BigMath
{
     ...
     * <p>
     * Works for really big integers (practically unlimited), even when the argument falls outside the <tt>double</tt> range
     * <p>
     ...
     * <p>
     * Works for very big and very small exponents, even when the result falls outside the double range
     *
     ...
     */
    public static BigDecimal powBig(double a,
        double b)
    {
